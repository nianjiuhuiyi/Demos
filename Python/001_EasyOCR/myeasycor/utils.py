...
def group_text_box(polys_list, slope_ths = 0.1, ycenter_ths = 0.5, height_ths = 0.5, width_ths = 1.0, add_margin = 0.05, sort_output = True):
    results1 = []
    results2 = []
            ...
            if len(boxes) == 1: # one box per line
                ...
                for mbox in merged_box:
                    if len(mbox) != 1: # adjacent box in same line
                        ...
                        merged_list.append([box[0]-margin,box[1]+margin,box[2]-margin,box[3]+margin])
        results1.append(merged_list)
        results2.append(free_list)
